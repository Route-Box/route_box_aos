...
import com.example.routebox.presentation.config.ApplicationClass.Companion.X_ACCESS_TOKEN
import com.example.routebox.presentation.config.ApplicationClass.Companion.X_REFRESH_TOKEN
import com.example.routebox.presentation.config.ApplicationClass.Companion.sSharedPreferences
        ...
        when (response.code) {
            ...
            403 -> {
                ...
                val newTokenResponse = runBlocking {
                    apiService.refreshToken(LoginRequest(accessToken.toString(), refreshToken))
                }
